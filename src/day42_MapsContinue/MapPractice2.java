...
public class MapPractice2 {
    public static void main(String[] args) {
            ...
            for (Map<String, Object> eachMap : listOfMaps) {
                for (Map.Entry<String, Object> eachEntry : eachMap.entrySet()) {//eachMap.entrySet().for==>Shortcut
            ...
            listOfMaps.get(1).replace("age",   ( (Integer)listOfMaps.get(1).get("age")) + 4) ;//original age+4
            ...
            List<Map<String, Object>> cars = new ArrayList<>();//list of maps
