...
public class IteratingMap {
    public static void main(String[] args) {
        ...
        Map<String, Integer> map = new LinkedHashMap<>(); // insertion order, accept null key & null values
        ...
        for (String eachKey : map.keySet()) {//keySet() method for iterating each key
