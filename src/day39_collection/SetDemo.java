...
public class SetDemo {
    public static void main(String[] args) {
        ...
        //[10, 200, 300, 40, 90, 10, 200, 300, 40, 90, 10, 200, 300, 40, 90, 10, 200, 300, 40, 90]
        ...
        */
        ...
        System.out.println( new ArrayList<>(result).get(1) ); //converting Set to ArrayList
        ...
        Set<Integer> n = new TreeSet<>(numbers); // List to Set - ArrayList converted to TreeSet
        //Removes duplicates and ascending order==>TreeSet
