...
public class WarmUpTasl_employee {
...
//1.1 Write a program that can display the name and job title of each employee
        ...
        for (Employee each : employees) {
            if (each.jobTitle.equals("Java Developer")) {//if job title is Java Developer
                System.out.println(each.name); //Print name of the all Java Developers
            }
        }
        ...
        double max = employees.get(0).salary; //compare first persons salary to others salary
        ...
        /*4 Create two arraylists named femaleEmployees and maleEmployees, write a program that
        ...
        System.out.println("Total number of female employees: " + female.size());
        System.out.println("Total number of male employees: " + male.size());
